...
// Sim side follows the CURRENT production (v3.6 via island_frames_v36.root).
void zsize_physics(){
  ...
  TFile*fv=TFile::Open("island_frames_v36.root"); TTree*si=(TTree*)fv->Get("island");
  ...
  L2->AddEntry(d,"REAL islands","l"); L2->AddEntry(e,"SIM v3.6","l"); L2->Draw();
  c.cd(3);
  ...
  L3->AddEntry(p1,"REAL islands","l"); L3->AddEntry(p2,"SIM v3.6","l"); L3->Draw();
