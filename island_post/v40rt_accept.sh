...
TFile*fs=TFile::Open(\"digi_frames_production_v40rt.root\"); TTree*ts=(TTree*)fs->Get(\"ntp_hit\");
...
root -l -b -q -e "gROOT->ProcessLine(\".L b42_metrics.C+\"); b42_metrics(\"digi_frames_production_v40rt.root\",\"v36revB\");" 2>&1 | grep -E "B42METRIC|B43REGION"
...
TFile*fs=TFile::Open(\"island_frames_v40rt.root\"); TTree*is=(TTree*)fs->Get(\"island\");
