...
RSPEC="460:1,784:1,812:1,826:1,826:1,827:1,831:1,832:1,841:1,849:1"
...
hadd -f frames_pau_production_v40b.root fP_*.root > /dev/null 2>&1
hadd -f digi_frames_production_v40b.root dP_*.root > /dev/null 2>&1
hadd -f island91_frames_production_v40b.root i91_*.root > /dev/null 2>&1
rm -f fP_*.root dP_*.root i91_*.root
root -l -b -q -e 'gROOT->ProcessLine(".L islandize.C+"); islandize("digi_frames_production_v40b.root","island_frames_v40b.root",1);' 2>&1 | grep islandize
echo "=== V40B PRODUCTION COMPLETE ==="
