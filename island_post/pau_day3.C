void pau_day3(){
  ...
  TFile*fs=TFile::Open("island91_frames_production_v32.root");  TTree*s=(TTree*)fs->Get("ntp_cluster");
  ...
  auto d2=[&](TH1*a,TH1*b,const char*xt,const char*ti,bool logy,bool perEv){
    ...
    L->AddEntry(a,"REAL island91","l"); L->AddEntry(b,"SIM pAu frames v2","l"); L->Draw(); };
