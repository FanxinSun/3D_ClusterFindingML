...
// now with exam6/pAu v3.6 frames: both datasets carry APPARENT z with the same mapping
...
void z_bridge(){
  ...
  TH2D*h2=new TH2D("h2","SIM v4.0: apparent z vs tbin;tbin;z [cm]",194,0,970,140,-320,320);
  ...
  L.AddEntry(z1,"REAL","l"); L.AddEntry(z2,"SIM v4.0","l"); L.Draw();
  c.SaveAs("/home/rog/sPHENIX/3D_ClusterFindingML/sim_validation_plots/z_bridge.png");
  printf("saved z_bridge.png (pAu v3.6)\n");
}
