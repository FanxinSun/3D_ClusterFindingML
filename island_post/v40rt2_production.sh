...
RSPEC="374:1,638:1,661:1,672:1,672:1,673:1,676:1,677:1,684:1,690:1"
...
hadd -f frames_pau_production_v40rt2.root fP_*.root > /dev/null 2>&1
hadd -f digi_frames_production_v40rt2.root dP_*.root > /dev/null 2>&1
hadd -f island91_frames_production_v40rt2.root i91_*.root > /dev/null 2>&1
rm -f fP_*.root dP_*.root i91_*.root
root -l -b -q -e 'gROOT->ProcessLine(".L islandize.C+"); islandize("digi_frames_production_v40rt2.root","island_frames_v40rt2.root",1);' 2>&1 | grep islandize
echo "=== V4.0RT2 PRODUCTION COMPLETE ==="
