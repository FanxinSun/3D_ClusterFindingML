...
//   RIGHT: SIM pAu frames v2 (exam6 library through P0-P3), layer 15 — the frame
...
void funny_shapes(const char *realpix =
                  ...
                  const char *simpix = "digi_frames_production_v34.root",
                  ...
                  const char *tag = "pAu v3.4 (B4.3)")
{
  ...
  c.SaveAs(out);
  printf("funny_shapes.png: original-purpose view regenerated (real evt %d vs pAu v2 frame %d)\n", realevent, bestfr);
}
