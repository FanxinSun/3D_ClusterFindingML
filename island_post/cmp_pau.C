...
void cmp_pau(){
  ...
  // ---- hits: THREE-WAY — real vs detached B3 frames vs container ----
  TFile*fb=TFile::Open("digi_frames_production_v32.root"); TTree*bh=(TTree*)fb->Get("ntp_hit");
  auto d3=[&](TVirtualPad*p,TH1D*a,TH1D*b,TH1D*g,const char*ti,bool logy){
    ...
    L->AddEntry(a,"REAL","l");
    L->AddEntry(b,"SIM detached pipeline (B3 frames)","l");
  ...
  TFile*fb2=TFile::Open("island91_frames_production_v32.root"); TTree*bc=(TTree*)fb2->Get("ntp_cluster");
