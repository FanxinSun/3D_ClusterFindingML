...
auto sp=[](const char*fn,const char*tag){
  ...
  printf(" | nbright %.5f\n", nb); };
sp("island_frames_v40b.root","sim"); sp("island_real.root","real");' 2>&1 | grep PHISPEC

echo "=== [C] prodclus v36 (ML baseline) ==="
root -l -b -q -e 'gROOT->ProcessLine(".L prodclus.C+");
prodclus("digi_frames_production_v40b.root","prodclus_v40b.root",1,5.0,3.0,5.0,0,10,20,1,"","frames_pau_production_v40b.root");' 2>&1 | grep prodclus:
...
cp -f /home/rog/sPHENIX/3D_ClusterFindingML/sim_validation_plots/funny_shapes.png \
      /home/rog/sPHENIX/3D_ClusterFindingML/sim_validation_plots/funny_shapes_v40.png
